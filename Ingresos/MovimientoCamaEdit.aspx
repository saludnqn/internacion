<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="MovimientoCamaEdit.aspx.cs" Inherits="WebInternacion2.Ingresos.MovimientoCamaEdit" %>
...
<asp:Content ID="content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        $(function () {
            $("#<%=txtFechaMov.ClientID %>").datepicker({
                showOn: 'button',
...
<asp:Content ID="content" ContentPlaceHolderID="cuerpo" runat="server">
    <table class="myTabla" style="width: 900px;">
        <tr>
            <td class="mytituloTabla">MOVIMIENTO DE CAMA
            </td>
        </tr>
        <tr>
            <td>
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 222px">
                                        <input id="txtFechaMov" runat="server" type="text" maxlength="10" onblur="valFecha(this)"
                                            onkeyup="mascara(this,'/',patron,true)" tabindex="1" class="myTexto" style="width: 70px" /><asp:RequiredFieldValidator
                                                ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtFechaMov" ErrorMessage="Fecha del Pase"
                                                ValidationGroup="0">*</asp:RequiredFieldValidator>
                                        <asp:CustomValidator ID="cvFecha" runat="server" ControlToValidate="txtFechaMov" ErrorMessage="La fecha del cambio de cama no puede ser inferior a la del último movimiento ni 
                                        puede ser superior a la fecha de hoy."
                                ...
                                <tr>
                                    ...
                                    <td style="width: 222px">
                                        <anthem:DropDownList ID="ddlServicio" runat="server" ToolTip="Seleccione el servicio" DataTextField="nombre" DataValueField="idServicio"
                                            TabIndex="3" CssClass="myList" OnSelectedIndexChanged="ddlServicio_SelectedIndexChanged" Enabled="false"
                                            AutoCallBack="True">
                                        </anthem:DropDownList>
