<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Cie10.ascx.cs" Inherits="WebInternacion2.UserControls.Cie10" %>
<script type="text/javascript">
    $(function () {
        var tipoBusqueda = $("#<%= rdbTipoBusqueda.ClientID %> input:checked").val();
        $('#<%= txtAutocie10.ClientID %>').autocomplete({ source: '<%= ResolveUrl("~/Services/DiagnosticoServices.aspx?tipoBusqueda=' + tipoBusqueda + '")%>', minlenght: 3,
...
<table class="autoCompleter">
    <tr>
        <td>
            <asp:TextBox runat="server" ID="txtAutocie10" Columns="58" 
                AutoPostBack="false" ></asp:TextBox>
        </td>
        <td>
            <asp:RadioButtonList ID="rdbTipoBusqueda" runat="server" RepeatDirection="Horizontal" 
                AutoPostBack="true" Font-Names="Arial" Font-Size="8pt" ontextchanged="rdbTipoBusqueda_TextChanged">
        ...
        <td align="left">
            <a href="javascript:LimpiarPrincipal();" id="hlLimpiar" style="float: left;">
                <asp:Image ToolTip="Borrar" runat="server" ID="imgLimpiar" ImageAlign="AbsMiddle"
                    ImageUrl="~/App_Themes/default/images/textfield_delete.png" AlternateText="Borrar valor" /></a>
        </td>
    </tr>
    <tr>
        <td colspan="2">
